...
class FriendProfile extends StatelessWidget {
  ...
  FriendProfile({Key? key, required this.name, required this.bio, required this.mood}) : super(key: key);
            ...
            child: SafeArea(
              child: Column(children: [
                ...
                Padding(
                    ...
                    child: Container(
                      child: Text(bio ?? 'Hey There Im using GEC Connect'),
                    )),
                // Container(
                ...
                Padding(
                    padding: EdgeInsets.only(right: 10, left: 10, bottom: 10),
                    child: Container(
                      child: Text(mood ??"Please update your mood"),
                    )),
                // Container(
                //   decoration: BoxDecoration(
                //     boxShadow: [
